...
class SettingsScreen extends React.Component {
  ...
  renderAction(userData) {
    ...
    else if (userData.subscriptionLevel === 5)
      return (
        <Text style={styles.alignRightText}>
          Upgrade to{' '}
    ...
    else if (userData.subscriptionLevel === 4)
      return (
        <Text style={styles.alignRightText}>
          Upgrade to{' '}
    ...
    else if (userData.subscriptionLevel === 3)
      return (
    ...
    else if (userData.subscriptionLevel === 2)
      return (
        <View style={styles.columnView}>
          <Text style={styles.alignRightText}>Go AD FREE or Subscribe</Text>
        </View>
      );
    else if (userData.subscriptionLevel === 1)
  ...
  render() {
    return (
      <View style={styles.container}>
        {this.state.userData.subscriptionLevel === 7 ? (
        ...
        <View style={styles.alignCenterView}>
          {this.state.userData.subscriptionLevel != 0 ? (
        ...
        <TouchableOpacity
          ...
          <Image
            style={styles.icon}
            source={
              this.state.userData.subscriptionLevel < 2
